                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active"> ایجاد سوالات   </li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ایجاد سوالات    </h3>

                            </div>
                            <!-- /.card-header -->
                            <div class="card-body table-responsive p-0">
                                <form method="post" action="{{ url('/ad/faqs/add/'.$cat_id) }}"
                                      enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" class="hidden" name="cat_id" value="{{ $cat_id  }}">
                                    <div class="card-body">
